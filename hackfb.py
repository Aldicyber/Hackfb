...
def siapa():
	...
	if nama =="":
		...
		os.system('clear')
		jalan("\033[1;97mSelamat datang \033[1;92m" +nama+ "\n\033[1;97mTerimakasih, add facebook Quotes Nolep !!")
		time.sleep(1)
		loginSC()
...
def loginSC():
	...
	if username =="Aldi" and password =="soleman":
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.facebook.com/Quotes.nolep86')
				menu()
